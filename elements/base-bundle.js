  ...
  Polymer({
    ...
    _getParameters: function(baseURI) {
      return Promise.resolve({
        importscript: new URL('/2015/bower_components/platinum-sw/bootstrap/simple-db.js', baseURI).href,
        importscriptLate: [
          new URL('/2015/bower_components/platinum-sw/bootstrap/sw-toolbox-setup.js', baseURI).href,
          new URL('/2015/bower_components/platinum-sw/bootstrap/offline-analytics.js', baseURI).href
        ]
      });
    }
  });
  ...
  Polymer({
    ...
    _getParameters: function(baseURI) {
      return new Promise(function(resolve) {
        var params = {
          importscriptLate: new URL('/2015/bower_components/platinum-sw/bootstrap/sw-toolbox-setup.js', baseURI).href,
...
(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
              ...
              })(window,document,'script','/2015/scripts/analytics.js','ga');
    ...
    _createClass(AppData, [{
      ...
      value: function beforeRegister() {
        ...
        this.properties = {
          speakersSource: {
            type: String,
            value: '/2015/data/speakers.json'
          },
          sessionsSource: {
            type: String,
            value: '/2015/data/sessions.json'
          },
          postsSource: {
            type: String,
            value: '/2015/data/blog.json'
          },
          partnersSource: {
            type: String,
            value: '/2015/data/partners.json'
          },
          scheduleSource: {
            type: String,
            value: '/2015/data/schedule.json'
          },
          speakers: {
            type: Array,
            notify: true
...
(function () {
  ...
  Polymer({
    ...
    _renderOpened: function _renderOpened() {
      page.redirect('/2015/' + app.route + '/' + this.speaker.id);
    ...
    _renderClosed: function _renderClosed() {
      page.show('/2015/' + app.route, null, false);
...
(function () {
  ...
  Polymer({
    ...
    _renderOpened: function _renderOpened() {
      page.redirect('/2015/' + app.route + '/' + this.session.id);
      if (this.withBackdrop && window.innerWidth > 960) {
        this.backdropElement.open();
      }
      this.playAnimation('entry');
...
(function () {
  ...
  var AnnounceBlock = function () {
    function AnnounceBlock() {
      _classCallCheck(this, AnnounceBlock);
    }

    _createClass(AnnounceBlock, [{
      key: 'beforeRegister',
      value: function beforeRegister() {
    ...
    _createClass(LatestPosts, [{
      ...
      value: function _postsChanged() {
        ...
        for (var i = 0, len = temp.length; i < len; i++) {
          temp[i].url = '/2015/blog/' + temp[i].id;
      ...
      value: function beforeRegister() {
        ...
        this.properties = {
          ...
          text: {
            ...
            value: 'Post about your experience at GDG DevFest Ukraine 2015'
          },
          when: Date,
          canonicalUrl: String,
          sign: String
      ...
      value: function beforeRegister() {
        ...
        this.properties = {
          images: {
            type: Array,
            /* jshint ignore:start */
            value: ["/2015/images/backgrounds/location_1.jpg", "/2015/images/backgrounds/location_2.jpg", "/2015/images/backgrounds/location_3.jpg"]
            /* jshint ignore:end */
          },
          options: {
            type: String,
      ...
      value: function beforeRegister() {
        ...
        this.properties = {
          ...
          _heroSettings: {
            ...
            /* jshint ignore:start */
            value: function value() {
              return { "backgroundColor": "#00BCD4", "backgroundImage": "/2015/images/backgrounds/home.png", "fontColor": "#FFFFFF", "tabBarColor": "#FFFFFF", "video": { "title": "GDG DevFest Ukraine 2015", "youtubeId": "DfMnJAzOFng", "text": "See how it was in 2015" } };
            }
            /* jshint ignore:end */
          },
      ...
      value: function beforeRegister() {
        ...
        this.properties = {
          ...
          _heroSettings: {
            ...
            /* jshint ignore:start */
            value: function value() {
              return { "backgroundColor": "#03A9F4", "fontColor": "#FFFFFF", "tabBarColor": "#FFFFFF" };
            }
            /* jshint ignore:end */
          },
  ...
  Polymer({
    ...
    _postChanged: function _postChanged() {
      if (this.selected && this.postId) {
        ...
        this._postUrl = '/2015/posts/' + this._post.posted + '-' + this.postId + '.markdown';
